...
namespace EMS_Full_Stack.Controllers
{
    ...
    {
        private readonly EMS_Full_StackContext _context;

        public EmpProfilesController(EMS_Full_StackContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfile == null)
          {
              return Problem("Entity set 'EMS_Full_StackContext.EmpProfile'  is null.");
          }
